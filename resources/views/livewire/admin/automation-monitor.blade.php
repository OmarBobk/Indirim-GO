                        ...
                        @foreach ($this->runs as $run)
                            ...
                            >
                                ...
                                <td class="px-4 py-3 text-end" wire:click.stop>
                                    @if ($run->status === \App\Enums\FulfillmentAutomationRunStatus::NeedsReview)
                                        <flux:button
                                            size="sm"
                                            variant="primary"
                                    ...
                                    @elseif ($run->status === \App\Enums\FulfillmentAutomationRunStatus::Failed)
        ...
        >
            @if ($this->selectedRun)
                ...
                <div class="flex flex-wrap gap-2 border-t border-zinc-100 bg-zinc-50/80 p-4 dark:border-zinc-800 dark:bg-zinc-950/50">
                    @if ($panelRun->status === \App\Enums\FulfillmentAutomationRunStatus::NeedsReview)
