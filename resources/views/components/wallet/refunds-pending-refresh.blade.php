<div
    ...
    role="status"
    aria-live="polite"
    data-test="refunds-pending-refresh"
>
    <flux:text class="text-sm text-zinc-800 dark:text-zinc-100">
        {{ __('messages.refunds_updates_available') }}
    </flux:text>
    <flux:button
        variant="primary"
        size="sm"
        ...
        data-test="refunds-return-latest"
    >
        <span wire:loading.remove wire:target="applyPendingRefresh">{{ __('messages.refunds_return_latest') }}</span>
