 ...
 *
 * Implements {@see ImplicitRule} so the check still runs when the field is
 * missing entirely (e.g. a bot that never renders the widget script).
 *
 ...
 */
final class TurnstileChallenge implements ImplicitRule, ValidationRule
{
